...
import { getBalagruha, getTasks, updateTask, fetchUsers, getStudentListforAttendance, getMachines, getTaskBytaskId, createTraining, getTraining, updateTraining, deleteTrainign, coachBasedUsers } from "../../api";
        ...
        <div className="training-filter" ref={filterRef}>
            <div className="filter-buttons">
                <div style={{ position: 'relative' }}>
                    ...
                    >
                        Balagruha {filters.balagruhaIds?.length > 0 && `(${filters.balagruhaIds.length})`}
                    </button>
...
const MusicCoachDashboard = () => {
    ...
    const getTrainingSessions = async (filters) => {
        try {
            ...
            if (filters.balagruhaIds.length !== 0) {
                ...
                balagruhaIds = "67e90b97f85808bbedb325b7,67e90becf85808bbedb325c9,67e90ccff85808bbedb32690,67e90d00f85808bbedb32699,67e910bab77f10b9b20e23d9,67e9159f5071b4b7175342b5,67e915f65071b4b717534358,67ea7d5e2b7ffe9e17e8c93c"
            }
    ...
    const handleSaveSession = async (sessionData) => {
        ...
        if (editingSession?._id) {
            const response = await updateTraining(editingSession._id, JSON.stringify(sessionData))
            getTrainingSessions(trainingFilters);
        } else {
    ...
    const assignedStudents = [
        ...
        },
        {
            ...
            taskDescription: "Perform 15-minute vocal warm-ups including arpeggios and sirens.",
            dueDate: "2025-04-06",
            priority: "High",
        ...
        },
        {
            ...
            taskDescription: "Practice transitioning between G, D, and C chords smoothly.",
            dueDate: "2025-04-07",
            priority: "Low",
            attachedMedia: ""
        },
                                                    ...
                                                    .map(session => (
                                                        <div key={session._id} className="session-item">
                                                            ...
                                                            <div className="session-details">
                                                                <h4>{session.title}</h4>
                                                                <p>{session.location} • {session.assignedStudents?.length || 0} students</p>
                                                            </div>
                                                            <button
                        ...
                        <div className="music-students-section">
                            ...
                            <div className="music-filter-container">
                                ...
                                <div className="music-filter-actions">
                                    ...
                                    <button className="music-filter-button clear">Clear Filters</button>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                        {assignedStudents.map((student) => (
                                            <tr key={student.id}>
                                                ...
                                                <td>{student.taskDescription || "No description provided"}</td>
                                                <td>{new Date(student.dueDate).toLocaleDateString()}</td>
                                                <td>
                                                    <span
                                                        className={`priority-tag ${student.priority === "High"
                                                            ? "high"
                                                ...
                                                <tr key={session._id}>
                                                    ...
                                                    <td>
                                                        <div className="notification-preferences">
                                                            ...
                                                            {session?.notificationPreferences.length > 0 ? session?.notificationPreferences.join(',') : '--'}
