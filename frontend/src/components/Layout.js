...
const Layout = () => {
    ...
    const topMenus = [
        ...
        { id: 8, name: "Repairs", link: "/repair", module: "Role Management", action: "Read" },
        { id: 9, name: "Purchase", link: "/purchase", module: "Role Management", action: "Read" },
    ...
    return (
        <div className="app-layout">
            ...
            {
                (localStorage.getItem('role') === 'admin' || localStorage.getItem('role') === 'coach' || localStorage.getItem('role') === 'student') &&
