...
exports.fetchTasksByUserIdAndFilter = async (userId, filter) => {
    return await Task.find({ assignedUser: userId, }).lean()
        .then(result => {
            return {
                success: true, data: result, message: "Fetched all task successfully"
            }
        }).catch(error => {
...
exports.createTask = async (payload) => {
    return await Task.create([payload])
        .then(result => {
            return {
                success: true, data: result, message: "Created task successfully"
            }
        }).catch(error => {
            console.log('error', error)
            throw error;
...
exports.getTaskOverviewDetailsByBalagruhaIds = async (balagruhaIds) => {
    ...
    return await Task.aggregate(pipeline).then(result => {
        return {
            success: true, data: result, message: "Fetched all task successfully"
        }
    }).catch(error => {
...
exports.getTaskById = async (taskId) => {
    return await Task.findOne({ _id: taskId }).lean()
        .then(result => {
            return {
                success: true, data: result, message: "Fetched task successfully"
            }
        }).catch(error => {
            console.log('error', error)
            throw error;
...
exports.updateTaskById = async ({ taskId, payload }) => {
    return await Task.findByIdAndUpdate
        (taskId, payload, { new: true })
        .then(result => {
            return {
                success: true, data: result, message: "Updated task successfully"
            }
        })
        .catch(error => {
            console.log('error', error)
