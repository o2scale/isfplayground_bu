...
router.get("/overview", authenticate, authorize('Task Management', 'Read'), getSportsInsights);
// API for fetch the list of sports training sessions ( pass balagruhaIds and type as query param)
router.get("/training-sessions", authenticate, authorize('Task Management', 'Read'), getAllTrainingSessions);
